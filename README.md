...
Links:
    ...
    Description: MeteoSwiss daily station data from Basel-Binningen (station BAS), including mean temperature, precipitation, and other meteorological variables. 
